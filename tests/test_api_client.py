...
class TestWebhookLimitError:
    ...
    @pytest.mark.asyncio
    async def test_409_without_webhook_limit_raises_api_error(
        self, api_client: ApiClient
    ) -> None:
...
class TestFilterSerialization:
    ...
    def test_serialize_filter_rule_without_case_sensitive(
        self, api_client: ApiClient
    ) -> None:
    ...
    def test_serialize_filter_config_with_require_auth(
        self, api_client: ApiClient
    ) -> None:
    ...
    def test_serialize_filter_config_without_require_auth(
        self, api_client: ApiClient
    ) -> None:
